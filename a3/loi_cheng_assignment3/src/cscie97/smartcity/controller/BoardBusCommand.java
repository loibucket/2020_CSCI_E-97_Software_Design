    ...
    public void execute() throws ServiceException {
        ...
        try {
            ...
            if (person.getType() == PersonType.resident) {
                ...
                CommandProcessor.processCommand("process-transaction 1 amount " + bus.getFee() + " fee 10 note \"board bus\" payer " + person.getBlockchainAddress() + " receiver " + cityBlockchain, -1);
                CommandProcessor.processCommand("get-account-balance " + person.getBlockchainAddress(), -1);
            }
        } catch (Exception e) {
