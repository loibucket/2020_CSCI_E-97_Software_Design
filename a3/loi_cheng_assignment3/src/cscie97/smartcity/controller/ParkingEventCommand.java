...
public class ParkingEventCommand implements Command {
    ...
    public void execute() throws ServiceException {
        ...
        try {
            CommandProcessor.processCommand("get-account-balance " + vehicleId, -1);
            CommandProcessor.processCommand("process-transaction 1 amount " + charge + " fee 10 note \"parking\" payer " +
